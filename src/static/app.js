document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    ...
    try {
      ...
      // Note: We handle "All Levels" (no difficulty) on the client side
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter for "All Levels" (empty string)
      // "All Levels" means show only activities with NO difficulty_level specified
      if (currentDifficulty === "" && details.difficulty_level) {
        return;
      }
  ...
  function getActivityShareText(name, details) {
    ...
    return `Check out this activity at Mergington High School: ${name}\n\n${details.description}\n\nSchedule: ${formattedSchedule}`;
  }
  ...
  function renderActivityCard(name, details) {
    ...
    copyBtn.addEventListener("click", () => copyShareLink(name, details));
